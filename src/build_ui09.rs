...
//
    ...
    v2box.attach(&mscrollfrom_window, 0, 5 , 2, 4);
    v2box.attach(&mscrollto_window, 2, 5 , 2, 4);
    v2box.attach(&mprevimageto_label, 4, 5 , 1, 1);
    v2box.attach(&mcurrimageto_label, 4, 6 , 1, 1);
    v2box.attach(&mafterimageto_label, 4, 7 , 1, 1);
