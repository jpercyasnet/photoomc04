...
//        let dialog = FileChooserDialog::new(Some("Choose a Directory 1"), Some(&window.clone()), FileChooserAction::SelectFolder,&[("Cancel", gtk::ResponseType::Cancel),("Accept", gtk::ResponseType::Ok)]);
...
//        let result = dialog.run();
        ...
        dialog.connect_response(move |d: &FileChooserDialog, response: gtk::ResponseType| {
            if response == gtk::ResponseType::Ok {
                ...
                messageval_label.set_markup("<span color=\"#FF000000\">********* Directory 1: ERROR OK button not selected **********</span>");
            }
...
//        dialog.close();
        ...
        dialog.connect_response(move |d: &FileChooserDialog, response: gtk::ResponseType| {
            if response == gtk::ResponseType::Ok {
                ...
                messageval_label.set_markup("<span color=\"#FF000000\">********* Directory 2: ERROR OK button not selected **********</span>");
            }
...
//        dialog.close();
        ...
        dialog.connect_response(move |d: &FileChooserDialog, response: gtk::ResponseType| {
            if response == gtk::ResponseType::Ok {
                ...
                messageval_label.set_markup("<span color=\"#FF000000\">********* org Out Directory: ERROR OK button not selected **********</span>");
            }
...
fn main() {
    let application =
        gtk::Application::new(Some("com.omc"), Default::default())
