...
//                    let tofilestart1 = 9;
                    ...
                    if !odir1chkbox_check.is_active() {
                        ...
                        let takedatestr1 = takedate1.unwrap().to_string();
                        if takedatestr1.len() < 26 {
                            let imgdate1 = modelt1.get_value(&itert1, 2).get::<String>();
                            let imgdatestr1 = imgdate1.unwrap().to_string();
                            if imgdatestr1.len() < 26 {
                                let moddate1 = modelt1.get_value(&itert1, 3).get::<String>();
                                let moddatestr1 = moddate1.unwrap().to_string();
                                if moddatestr1.len() < 26 {
...
//                        let tofilestart2 = 9;
                        ...
                        if !odir2chkbox_check.is_active() {
                            ...
                            let takedatestr2 = takedate2.unwrap().to_string();
                            if takedatestr2.len() < 26 {
                                let imgdate2 = modelt2.get_value(&itert2, 2).get::<String>();
                                let imgdatestr2 = imgdate2.unwrap().to_string();
                                if imgdatestr2.len() < 26 {
                                    let moddate2 = modelt2.get_value(&itert2, 3).get::<String>();
                                    let moddatestr2 = moddate2.unwrap().to_string();
                                    if moddatestr2.len() < 26 {
...
// save the from file name
                fromfilename = filenameval.unwrap().to_string();
...
//                        let tofileend = tofileln - 3;
//                        let tofilestart = 9;
                        let tofilename = tofilenameval.as_ref().unwrap().to_string();
                        let tofilenamey = tofilenameval.unwrap().to_string();
